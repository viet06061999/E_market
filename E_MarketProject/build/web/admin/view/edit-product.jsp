                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <form role="form" action="ProductEditServlet" method="post"
                                                      enctype="multipart/form-data">
                                                    <input name="id" value="${product.getMa_san_pham()}" hidden="">
                                                <div class="form-group">
                                                    <label>Name:</label> <input class="form-control"
                                                                                value="${product.getTen_san_pham()}" name="name" />
                                                </div>
                                                <div class="form-group">
                                                    <label>Price ($)</label> <input class="form-control"
                                                                                    value="${product.getGia_ban()}" type="number" name="price" />
                                                </div>
                                                <div class="form-group">
                                                    <label>Hang_san_xuat:</label> <input class="form-control"
                                                                                         value="${product.getHang_san_xuat()}" name="hangsx" />
                                                </div>
                                                <div class="form-group">
                                                    <label>Description </label> <br>
                                                    <textarea rows="4" cols="50" name="des" id="editer" >${product.getThong_tin()}</textarea>
                                                </div>
