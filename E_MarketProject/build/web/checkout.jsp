                    ...
                    <div class="totals">
                        <div class="totals-item">
                            ...
                            <div class="totals-value" id="cart-subtotal"><%=nf.format(total)%>
                                ...
                                <center>       <span style="font-size: 32px;color: black; background-color: graytext">Thông tin giao hàng</span></center>
                  <form class="box login" action="CheckoutServlet" method="post">
